...
export const BUILDING_CONFIGS: Record<BuildingType, BuildingConfig> = {
  ...
  [BuildingType.ACADEMY]: {
    ...
    maxPerPlayer: 2,
    description: 'Trains advanced Human units like Medics and Ghosts.',
  },
  ...
  [BuildingType.HATCHERY]: {
    ...
    production: { mineralPerTick: 0, gasPerTick: 5, energyPerTick: 0 },
    energyConsumptionPerTick: 8,
    maxPerPlayer: 2,
    description: 'Zerg expansion structure; trains large and elite Zerg units.',
  },
  [BuildingType.TURRET]: {
    buildTimeSeconds: 35,
